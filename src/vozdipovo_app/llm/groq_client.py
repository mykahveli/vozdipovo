#!filepath: src/vozdipovo_app/llm/groq_client.py
...
from vozdipovo_app.llm.settings import GroqSettings
...
class GroqClient:
    ...
    def chat(self, req: ChatRequest) -> ChatResponse:
        ...
        return ChatResponse(content=content, provider="groq", model=model, raw=data)
